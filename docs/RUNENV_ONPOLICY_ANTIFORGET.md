...
- Hang-era fixtures `loadout_v1_01/02/03` (per-fixture relics/potions: Shuriken / Bag of Marbles / Vajra — **not** homogenized)
- Encounters 16–21 (elite+boss)
- Seeds `40000+fix*1000+enc*100+ep`
- Gate: overall **≥0.70**, Boss **≥0.40** on this protocol (hang table 74.2 / 98.9 / Boss 49.4)
