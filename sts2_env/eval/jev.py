...
MAP low-HP routing implementation details are owned by ``sts2_env.eval.map_lowhp``.
Existing public exports are preserved here for backwards compatibility.
...
class JevAnswer:
    ...
    def as_log(self) -> dict[str, Any]:
        ...
        log["map_lowhp_soft_b"] = self.fallback_reason == MAP_LOWHP_SOFT_B_REASON
