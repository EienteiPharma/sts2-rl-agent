"""Jev / TypeSafe adapter for Act1 RunEnv non-combat decisions (thin public facade).

Public facade re-exporting:
- map_lowhp: Low-HP MAP fork routing helpers and constants
- jev_types: Typed Choice / Score types, criteria, thresholds, and answer parsing
- jev_telemetry: Telemetry and shadow logging helpers
- jev_keys: TypeSafe / Jev API key management and environment auth wiring
- jev_client: Transport and client adapters for TypeSafe / Jev System One calls
- jev_fallback: Client-layer confidence, score assist, and fallback helpers
"""
from __future__ import annotations

import time  # Re-exported for test monkeypatching compatibility (e.g. jev.time.sleep)
...
__all__ = [
    ...
    "UNKNOWN_MAP_CRITERION",
    "_parse_answer",
    # Telemetry (jev_telemetry.py)
    "default_shadow_fields",
    "format_shadow_log",
    # Auth & Keys (jev_keys.py)
    "BOX_SECRETS_PATH",
    "RECOMMENDED_N_ENVS_MAX",
    "TYPESAFE_API_KEYS_ENV",
    "TYPESAFE_API_KEY_ENV",
    ...
    "is_typesafe_forbidden",
    "typesafe_http_headers",
    # Fallback helpers (jev_fallback.py)
    "apply_choice_confidence",
    "local_hp_pressure",
    "rest_or_continue_override",
